...
public class GripPipeline implements Updatable {
	 ...
	 */
	public Rect process(Mat source0) {
		// Step Blur0:
		Mat blurInput = source0;
		BlurType blurType = BlurType.get("Median Filter");
		double blurRadius = 28.22822837142257;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {41.007192958173135, 180.0};
		double[] hsvThresholdSaturation = {12.230216191826964, 255.0};
		...
		return Imgproc.boundingRect(filterContoursOutput().get(0));
